...
import transition9.util.Constants;
...
/**
 *Use using transition9.ds.MapUtil 
 */
class MapUtil
{
	...
	{
		transition9.util.Assert.isNotNull(map, " map is null");
		transition9.util.Assert.isNotNull(fn, " fn is null");
		for (k in map.keys()) {
