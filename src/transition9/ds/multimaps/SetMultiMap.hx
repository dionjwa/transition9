 ...
 ******************************************************************************/
package transition9.ds.multimaps;

import transition9.ds.Map;
import transition9.ds.Maps;
import transition9.ds.MultiMap;
import transition9.ds.Set;
import transition9.ds.Sets;
import transition9.ds.multimaps.AbstractMultiMap;
	...
	implements MultiMap<K, V>
{
	...
	override public function set (key :K, value :V) :Void
	{
		...
		if (_valueType == null) {
			...
			transition9.util.Assert.isNotNull(_valueType, "Cannot get type of value=" + value);
		}
		super.set(key, value);
