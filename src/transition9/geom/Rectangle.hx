...
class Rectangle
{
   ...
   public function clone() : transition9.geom.Rectangle
   {
   ...
   public function containsRect(rect : transition9.geom.Rectangle) : Bool
   {
	 return contains(rect.x,rect.y) && containsPoint(rect.bottomRight);
   }
   public function equals(toCompare : transition9.geom.Rectangle) : Bool
   {
   ...
   public function intersection(toIntersect : transition9.geom.Rectangle) : transition9.geom.Rectangle
   {
   ...
   public function intersects(toIntersect : transition9.geom.Rectangle) : Bool
   {
	  var x0 = x<toIntersect.x ? toIntersect.x : x;
	  var x1 = right>toIntersect.right ? toIntersect.right : right;
	  if (x1<=x0)
   ...
   public function union(toUnion : transition9.geom.Rectangle) : transition9.geom.Rectangle
   {
