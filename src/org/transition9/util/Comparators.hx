...
class Comparators
{
	...
	inline public static function compareHashables (v1 :org.transition9.ds.Hashable, v2 :org.transition9.ds.Hashable) :Int
	{
		org.transition9.util.Assert.isNotNull(v1);
		org.transition9.util.Assert.isNotNull(v2);
