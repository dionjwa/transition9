 ...
 ******************************************************************************/
package org.transition9.ds.multimaps;
...
import org.transition9.ds.multimaps.AbstractMultiMap;
	...
	implements MultiMap<K, V>
{
	...
	override public function set (key :K, value :V) :Void
	{
		...
		if (_valueType == null) {
			...
			org.transition9.util.Assert.isNotNull(_valueType, "Cannot get type of value=" + value);
		}
		super.set(key, value);
