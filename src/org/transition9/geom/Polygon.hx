	...
	implements Cloneable<Polygon>
 {
	...
	public function new (vertices :Array<Vec2>) //<Vec2>
	{
		if (vertices == null || vertices.length < 3) {
			throw "Cannot create a polygon with < 3 vertices=" + vertices + " " + org.transition9.util.Log.getStackTrace();
		}
		_vertices = vertices;
		// polygon = _vertices;
...
//		}
	...
	{
		if (!isIntersection(p)) {
			org.transition9.util.Log.debug(["union, no intersection", "poly1", this, "poly2", p]);
			return new Polygon([]);
		}
